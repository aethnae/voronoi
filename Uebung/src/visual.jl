export main, Point2D, point2d, Graph2D, area, UserUnit, Area2D,
orientation
...
function main()
  ...
  # Dieser Block sorgt für das Layout der GUI

  win = GtkWindow("Drawing")
  g = GtkGrid()
  header = GtkLabel("Drawing Area")
  ...
  # Die tatsächliche Logik für die Mausklicks
    println(btn.button)
